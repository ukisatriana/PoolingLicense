...
export default function SupplierList() {
  ...
  return (
    <>
      ...
      />
      <AlertLocationDelete id={Number(customerDeleteId)} title={customerDeleteId} open={open} handleClose={handleClose} />
      <LocationModal open={userModal} modalToggler={setUserModal} customer={selectedCustomer} />
    </>
  );
}
